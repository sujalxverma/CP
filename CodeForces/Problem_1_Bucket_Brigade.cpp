...
void solve() {
    ...
    // same column
    if((fire.second == lake.second && lake.second == rock.second )){
        if(fire.first < rock.first && rock.first < lake.first){
            ans += 2;
        }else if(lake.first < rock.first && rock.first < fire.first){
            ans+=2;
        }
    }
    // same row
    else if((fire.first == lake.first && lake.first == rock.first )){
        if(fire.second < rock.second && rock.second < lake.second){
            ans += 2;
        }else if(lake.second < rock.second && rock.second < fire.second){
            ans+=2;
        }
    }
