...
/*
    If any element in d has freq. >= 2 and atleast 1 freq. remains, then we can assign all the values in d.
...
void solve(){
    ...
    map<ll, ll> mp;
    rep2(i,0,d) mp[c[i]]++; // map from d, not b
