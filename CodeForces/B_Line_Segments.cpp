...
void solve()
{
    ...
    long double D = sqrtl((c - a) * (c - a) + (d - b) * (d - b));
    ...
    // Check parity, consider it like vector, if it is odd then 1 vector remains, that cannot be canceeled.
    if ((ll)((total - D) + 1e-8) % 2 == 0)
    {
        yes;
    }
    else
