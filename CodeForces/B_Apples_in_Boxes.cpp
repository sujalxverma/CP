...
/*
    1. either for the very first turn condition >k matches, then jerry wins.
    2. now if sum of elements ,i.e total apple are even , then jerry will be the last one to choose. so he wins.
    3. otherwise tom wins
*/
